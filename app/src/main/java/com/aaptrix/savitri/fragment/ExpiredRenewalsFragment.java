...
public class ExpiredRenewalsFragment extends Fragment {
    ...
    private void setRenewalStatus() {
        if (checkConnection()) {
            ...
            try {
                ...
                JSONArray jsonArray = jsonObject.getJSONArray("expireRenews");
    ...
    private void listItem() {
        ...
        RenewalStatusAdapter adapter = new RenewalStatusAdapter(context, R.layout.list_renewal_status, renewalArray, "expire");
        ...
        new Thread(() -> {
            ...
            try {
                if (getContext() != null) {
                    File directory = context.getFilesDir();
                    directory.mkdir();
                    out = new ObjectOutputStream(new FileOutputStream(new File(directory, "expiredRenewalData")));
