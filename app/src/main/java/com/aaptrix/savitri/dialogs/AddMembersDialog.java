...
public class AddMembersDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		add.setOnClickListener(v -> {
			if (TextUtils.isEmpty(memberPhone.getText().toString())) {
				...
				if (makeAdminState) {
					addMember(memberPhone.getText().toString(), "Admin", strOrgId, memberName.getText().toString());
				} else {
					addMember(memberPhone.getText().toString(), "Team Member", strOrgId, memberName.getText().toString());
				}
			}
		});
	}
	...
	private void addMember(String phone, String makeAdmin, String orgId, String name) {
		new Thread(() -> {
			try {
