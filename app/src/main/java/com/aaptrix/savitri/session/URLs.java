...
public class URLs {
    ...
    public static final String FORGOT_PASSWORD = ROOT_URL + "forgot_password.php";
    public static final String SET_PASSWORD = ROOT_URL + "set_password.php";
    public static final String MEMBER_REGISTER_URL = ROOT_URL + "member_registration.php";
    public static final String VERIFY_PHONE_URL = ROOT_URL + "mobileVerification.php";
    public static final String ALL_STATE_URL = ROOT_URL + "allState.php";
    public static final String CITY_URL = ROOT_URL + "getCityByStateId.php";
    public static final String ALL_ISSUE_AUTH = ROOT_URL + "issuingAuthority.php";
    public static final String ADD_COMPLIANCE = ROOT_URL + "addCompliance.php";
    public static final String RENEW_COMPLIANCE = ROOT_URL + "complianceRenew.php";
    public static final String UPDATE_COMPLIANCE = ROOT_URL + "updateCompliance.php";
    public static final String ALL_PLANS = ROOT_URL + "allPlans.php";
    public static final String ALL_COMPLIANCE = ROOT_URL + "complianceList.php";
    public static final String ALL_PEOPLE = ROOT_URL + "allMemberList.php";
    public static final String DELETE_MEMBER = ROOT_URL + "deleteMember.php";
    public static final String DELETE_COMPLIANCE = ROOT_URL + "deleteCompliance.php";
    public static final String ALL_RENEWAL_STATUS = ROOT_URL + "allRenews.php";
    public static final String EXP_RENEWAL_STATUS = ROOT_URL + "expireRenews.php";
    public static final String ALL_FAQ = ROOT_URL + "allFaq.php";
    ...
    public static final String OFFLINE_PAYMENT = ROOT_URL + "offlinePayment.php";
    public static final String UPDATE_ORG = ROOT_URL + "orgDetailsUpdate.php";
    public static final String ORG_DETAILS = ROOT_URL + "org_all_details.php";
